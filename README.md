...
| 창 | 역할 | 여는 법 |
| --- | --- | --- |
| **오브** | 화면 구석의 구슬. 시각, 남은 할 일 개수, 오늘 일정 개수. 알림이 오면 옆에 말풍선 | 앱을 켜면 늘 떠 있음. 끌어서 옮김. 안 보이면 트레이의 "오브 표시/숨김" 또는 설정의 "오브 위치 초기화" |
...
└─ windows/
   ...
   ├─ orb/                      오브 (Orb.tsx 구슬, OrbApp.tsx 위치 저장·투명도, bubbleStore·Bubble 알림 말풍선 큐)
...
├─ reminders.rs                 1분마다 할 일을 읽어 알림(오브 보이면 말풍선 이벤트, 숨김이면 Windows 토스트), 발송 장부, 놓친 알림 요약
