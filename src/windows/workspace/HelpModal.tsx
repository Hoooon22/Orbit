...
const SECTIONS: { title: string; rows: Row[] }[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      ["Alt + Space", "Orbit 창 열기 + 앱 실행 — 앱 이름(초성도 됨)을 치고 Enter (설정에서 변경)"],
...
const TIPS: string[] = [
  ...
  "화면 구석의 오브(구슬)를 클릭하면 Orbit 창이 열리고, 끌면 자리를 옮깁니다. Orbit 창의 \"메모 열기\"가 이 창입니다. 트레이 메뉴에서 오브를 숨길 수 있습니다.",
  ...
  "이 창은 메모 전용입니다. 일정·클립보드·런처·설정은 화면 구석의 오브(구슬)를 눌러 여는 Orbit 창에 있습니다. 사이드바의 ⚙(또는 Ctrl+P → Orbit 열기)로도 갑니다.",
